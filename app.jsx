...
// Custom food icon component for Leaflet
...
// Map component that flies to new markers
...
export default function FoodMemoryApp() {
  const [foodMemories, setFoodMemories] = useState([]);
  ...
  const handleFileSelect = async (e) => {
    ...
    try {
      ...
      // Step 2: Upload original image and get background-removed version
  ...
  const defaultCenter = [40.7128, -74.006]; // NYC default
    ...
    <div style={{
      ...
      <header style={{
        ...
        <label style={{
          ...
          boxShadow: uploading ? 'none' : '0 4px 20px rgba(233, 69, 96, 0.4)',
        }}>
          <input
            ref={fileInputRef}
            type="file"
      ...
      {/* Memory sidebar (mobile: bottom sheet) */}
      {selectedMemory && (
        <div style={{
          position: 'fixed',
          bottom: 0,
